...
function loadPlayerInventory()
    ESX.TriggerServerCallback("s-inventory:getPlayerInventory",
        function(data)
            items = {}
            fastItems = {}
...
RegisterNetEvent("s-inventory:openTrunkInventory")
AddEventHandler(
    "s-inventory:openTrunkInventory",
    function(data, blackMoney, inventory, weapons)
        setTrunkInventoryData(data, blackMoney, inventory, weapons)
        openTrunkInventory()
    end
)
RegisterNetEvent("s-inventory:refreshTrunkInventory")
AddEventHandler(
    "s-inventory:refreshTrunkInventory",
    function(data, blackMoney, inventory, weapons)
        setTrunkInventoryData(data, blackMoney, inventory, weapons)
    end
)
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        TriggerServerEvent("s-inventory:changeFastItem", data.slot, data.item.name)
        loadPlayerInventory()
        cb("ok")
    end
)
RegisterNUICallback(
    ...
    function(data, cb)
        fastWeapons[data.item.slot] = nil
        TriggerServerEvent("s-inventory:changeFastItem", 0, data.item.name)
        loadPlayerInventory()
        cb("ok")
    end
)
...
--Add Items--
RegisterNetEvent('s-inventory:client:addItem')
AddEventHandler('s-inventory:client:addItem', function(itemname, itemlabel)
